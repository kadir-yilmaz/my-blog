// ==========================================
// 🎓 Static /uploads Fallback Route Handler
// ==========================================
// Next.js Standalone IIS ortamında /uploads/... yoluna gelen doğrudan istekleri
// diskten okuyup 404 hatası vermeden dinamik olarak servis eder.
...
export async function GET(
  ...
  try {
    ...
    console.error("❌ [API:uploads-fallback] Error serving image:", error);
